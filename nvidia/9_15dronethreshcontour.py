...
conf = json.load(open("nvconf.json"))
client = None
...
#servoPIN = UNKNOWN
#GPIO.setup(servoPIN, GPIO.OUT)
#GPIO.set(servoPIN, True)

#
#def pinPWM(duty):   #duty cycle in percent
#    while 1:
#        ontime = duty/100*
#        GPIO.set(servoPIN, True)
#	usleep(ontime)
#	GPIO.set(servoPIN, False)
#	usleep(5000-ontime)
def opendoor():
    print("we would have opened the door now")
#    p.ChangeDutyCycle(5)
#def arm():
